...
import { Autocomplete, Box, Button, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, TextField, Typography } from '@mui/material'
...
const CreateRiderDialog = ({ allGuardians, allSchools, allStops, cancelAction, createRider, disableButtons, isAddingRider, newRiderId, orgId, startAddingRider }: CreateRiderDialogProps) => {
